...
function RunScript()
{
    $clusters | ForEach-Object {
        ...
        $URI="https://management.azure.com/subscriptions/$AKS_SUBSCRIPTION/resourceGroups/$AKS_RG/providers/Microsoft.ContainerService/managedClusters/$AKS_NAME/start?api-version=2020-09-01"
